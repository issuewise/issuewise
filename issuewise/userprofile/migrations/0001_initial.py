    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(null=True, verbose_name="description of the user's activities while at, and any continuing relations, with the user/group", blank=True)),
                ('is_current', models.BooleanField(default=False, verbose_name='is the user currently involved with this user/group')),
                ('privacy', models.CharField(max_length=5, verbose_name='privacy settings', choices=[(b'A', b'all'), (b'F', b'friends only')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('privacy', models.CharField(max_length=5, verbose_name='privacy settings', choices=[(b'A', b'all'), (b'F', b'friends only')])),
                ('date_of_birth', models.DateField(null=True, verbose_name='born on', blank=True)),
                ('gender', models.CharField(blank=True, max_length=50, null=True, verbose_name='gender', choices=[(b'M', b'male'), (b'F', b'female')])),
                ('description', models.TextField(null=True, verbose_name='bio', blank=True)),
